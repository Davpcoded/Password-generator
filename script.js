...
//Created variable to store the password lenght
...
if (selectPass === passwordCrit[0]) {
    var numericalPassword = prompt("Now select password lenght min 8 charac. Max 128 charac.");
    passwordLength = numericalPassword.valueOf    
}
